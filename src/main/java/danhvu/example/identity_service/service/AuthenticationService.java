...
import danhvu.example.identity_service.dto.request.AuthenticationRequest;
import danhvu.example.identity_service.dto.request.IntrospectRequest;
...
public class AuthenticationService {
    ...
    public IntrospectResponse introspect(IntrospectRequest request)
        ...
        boolean notExpired = date != null && date.after(new Date());

        var verified = signedJWT.verify(verifier);
        boolean isValid = verified && notExpired;
